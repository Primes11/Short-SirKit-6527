...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        CameraServer.getInstance().startAutomaticCapture(0); // start cameras
    ...
    public void teleopPeriodic() {
        ...
        if (xboxController.getRawButton(4)) winch.set(1); // tells winch to move when button 4 is pressed
        else winch.set(0);
        if (xboxController.getRawButton(3)) dumper.set(0.5); // tells dumper to dump when winch is set
        else dumper.set(-0.5);
        ...
        if (!(xboxController.getRawButton(5) || xboxController.getRawButton(6) || -1 != pov)) { //if neither boost button nor the POV is used use standard joystick
            ...
            gyro_offset += xAxis / 11; //sets gyro axis, number after / sign is factor, greater number means it turns slower
